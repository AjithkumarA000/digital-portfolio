...
<body>
        <header>
            <div class="header-content">
               ...
               <img src="AJITHKUMAR A" alt="your profile picture" class="profile=picture">
               <h1>Ajithkumar</h1>
            ...
            <section id="about">
                <div class="section-content">
                     <h2>About Me</h2>
                     <p>Hello Everyone! This is AJITHKURAN A and i am a computer science learner.</p>
                </div>
            </section>
